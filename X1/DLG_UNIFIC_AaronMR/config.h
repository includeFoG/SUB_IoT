...
#define DEF_SENSOR_ID     "SSM-whst-009" //"SSM-Aport-003"   //"SSM-sens-002" // "SSM-whst-002" //"SSM-pres-002" //"SSM-desa-001" //"SSM-comp-001" // "SSM-test1"  //"SSM-test2"  //"SSM-hidroc-001" //"SSM-AnalizRed-002" 
...
#define DEF_WAIT_TIME     300 //TIEMPO ENTRE ENVIOS en segundos 
...
#define DEF_PROGRAM       "OHq"//"LIOQfSU"//"IOQfSU"//"GLDIOQvHU"  
//"GLBDIOQveBArOPSHVvU"    
...
//ASTICAN/IoT/ESTACIONES
#define DEF_TOPIC1_MQTT "ASTANDER" //"ASTICAN"
#define DEF_TOPIC2_MQTT "IoT"
#define DEF_TOPIC3_MQTT "ESTACIONES"    // "TANQUES" //"CPD" //"ANALIZADORESRED" // "PRESION" //"SUBSEA" //"ESTACIONES" //"COMPRESORES" //"HIDROCARB"
...
#define JSON_METEO       //usado para Meteo RK900 y RK300
//{"Dir_V","Vel_V","Temp","Hum","Pres_At","Rain","Pm2.5","Pm10","Noise"}
//[0] y [1]en MAIN case 12 [2] y [3] en case 7
...
String s_ValJSON_METEO[11];  // la meteo tiene 11 valores que hay que enviar.
