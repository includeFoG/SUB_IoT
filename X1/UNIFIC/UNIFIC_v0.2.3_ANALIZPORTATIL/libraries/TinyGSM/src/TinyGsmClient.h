...
#define TinyGsmClient_h
  ...
  typedef TinyGsmSaraR5::GsmClientSecure TinyGsmClientSecure;
  typedef TinyGsmSaraR5::GsmClient TinyGsmClient;
  
  #elif defined(TINY_GSM_MODEM_BC95G) 
  #define TINY_GSM_MODEM_HAS_GPRS
  #define TINY_GSM_MODEM_HAS_SSL
  #include <TinyGsmClientBC95G.h>
  typedef TinyGsmBC95G TinyGsm;
  typedef TinyGsmBC95G::GsmClient TinyGsmClient;
  typedef TinyGsmBC95G::GsmClientSecure TinyGsmClientSecure;
  ...
  typedef TinyGsmESP32::GsmClient TinyGsmClient;
  typedef TinyGsmESP32::GsmClientUDP TinyGsmClientUDP;
  typedef TinyGsmESP32::GsmClientSecure TinyGsmClientSecure;  
