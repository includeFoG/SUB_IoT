...
#define DEF_SENSOR_ID     "SSM-Aport-001"   //"SSM-sens-002" // "SSM-whst-002" //"SSM-pres-002" //"SSM-desa-001" //"SSM-comp-001" // "SSM-test1"  //"SSM-test2"  //"SSM-hidroc-001" //"SSM-AnalizRed-002" 
...
#define DEF_PROGRAM       "GLDIOQvHU"  //"CGLDEMQTU"//"GLDEOQTU"//"GLOS"//"GLOPTU"//"GLBAOPTU"//"GLBADEOPVTU" //-----NUEVOS: "DEGLMOQSVvU" //"GLBAOPSTVvU" //"DdGLOQSUVv" //TEST:"OPSTVvU" //"GLBACOPSVvH-" //"GLBsOQeSHVvU" //"GLBIOQveBArOPSHVvU"
//"GLBDIOQveBArOPSHVvU"    
...
#ifdef SSM_003
//#define JSON_ANALOG003;
//{"h","pbT","V","A","S1","S2","S3","S4"}
//[0] y [1]en MAIN case 12 [2] y [3] en case 7
//Resto del vector en analogReading.h
#endif

#ifdef SSM_005
//#define JSON_ANALOG005
//{"h","pbT","V","A","S1","S2","S3","S4","S5","S6","S7","S8"}
//[0] y [1]en MAIN case 12 [2] y [3] en case 7
//Resto del vector en analogReading.h
#endif
...
//#define JSON_METEO
//{"h","pbT","V","A","WSp","WPw","WDr","WGd","H","T","N","pm2","pm10","P","R","L"}
//[0] y [1]en MAIN case 12 [2] y [3] en case 7
//de [4 a 7] y  de[10 a 13] en myRS485.h
//[8]y[9] en forecast.h
//[14] y [15] en MAIN


//#define JSON_METEOFCAST
//{"h","pbT","V","A","WS","WP","WD","WG","H","T","N","pm2","pm10","P","R","L","ST","Pcs","DP","Prd","CPr"};//ST:Sensación Termica, Pcs: Precision, DP:Punto de rocio, Prd:Prediccion, CPr:Cambio de presión
//[0] y [1]en MAIN case 12 [2] y [3] en case 7
//de [4 a 7] y  de[10 a 12] en myRS485.h
//[8],[9],[13] en forecast.h
//[14] y [15] en MAIN
//de [16 a 20] en forecast.h
...
//#define JSON_AMPRS
//{"h","pcbT","InV","InA","A1","F1","A2","F2","A3","F3","A4","F4"}; //A: valor del amperimetro (A)  , F: Frecuencia de la red (Hz)
//[0] y [1]en MAIN case 12 [2] y [3] en case 7
//resto en case 30


//#define JSON_SIEMENSPAC
//{"h","pbT","V","A","Vff","F","Al1","Al2","Al3","IN","Pt","St","Qt"};
//  [0] y [1]en MAIN case 12 [2] y [3] en case 7

//#define JSON_HIDROCARB
// {"xh", "xT", "xV", "xA","T","hC"}
...
// static const String s_ParamJSON[13] = { "xh","xT","xV","xA","f1","Vff","Al1","Al2","Al3","An", "Wt","Qt","St"}
...
//int takeParam(const String nombre)
//{
//  bool match = false;
//  int indx = 0;
//  String s_aux = "";
...
//      {
//        Serial.println("ERROR, no se encuentra el nombre : " + String(nombre) + " en s_paramJSON, valor alcanzado de i: " + String(indx));
//        indx = 0;
//        match = true;
//      }
//      s_aux = "";
